...
{
    public class ActorControlEvent : BaseFFXIVEvent
    {
        ...
        public static EventHandler<ActorControlEvent>? OnEventFired;
        public static void RaiseEvent(object? sender, BaseFFXIVEvent xivEvent)
        {
            OnEventFired?.Invoke(sender, (ActorControlEvent)xivEvent);
        }
        ...
        {
            return $"ActorControl({SourceActorId}) {Category}: {Param1}, {Param2}, {Param3}, {Param4}";
        }
    }
}
